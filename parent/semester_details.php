...
<body>
    <div class="s-sem-details-container">
        ...
        $sql_student_details = "SELECT s.student_id, s.student_name FROM student s INNER JOIN parent p ON s.student_id = p.student_id WHERE p.parent_id = '$parent_id'";
        ...
        if ($result_student_details->num_rows > 0) {
            ...
            $student_name = $row_student_details['student_name'];
